...
# bitcore-wallet-service-finite

[![NPM Package](https://img.shields.io/npm/v/bitcore-wallet-service-finite.svg?style=flat-square)](https://www.npmjs.org/package/bitcore-wallet-service-finite)
[![Build Status](https://img.shields.io/travis/finitecoin/bitcore-wallet-service-finite.svg?branch=master&style=flat-square)](https://travis-ci.org/finitecoin/bitcore-wallet-service-finite)
[![Coverage Status](https://coveralls.io/repos/finitecoin/bitcore-wallet-service-finite/badge.svg?branch=master)](https://coveralls.io/r/finitecoin/bitcore-wallet-service-finite?branch=master)
...
# Getting Started
```
 git clone https://github.com/finitecoin/bitcore-wallet-service-finite.git
 cd bitcore-wallet-service-finite && npm start
```
